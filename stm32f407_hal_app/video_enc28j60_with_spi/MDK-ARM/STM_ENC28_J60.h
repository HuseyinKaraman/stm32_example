...
/* --------- Constants----------  */
// Operations defines 
#define ENC28_READ_CTRL_REG  0x00   // sayfa 28 de RCR ilk 3 biti 
#define ENC28_WRITE_CTRL_REG 0x40  // sayfa 28 de WCR ilk 3 biti  0x02
#define ENC28_BIT_FIELD_CLR  0xA0 // (BFC) SAYFA 28                0x05
#define ENC28_BIT_FIELD_SET  0x80 // (BFS)  SAYFA 28               0x04
#define ENC28_SOFT_RESET     0xFF // syf :28 de										0x07
// yukardakiler Opcode
// bunlardan sonra gelen 5 bitlik a = control register address
#define ENC28_READ_BUF_MEM		 0x3A //0x01
#define ENC28_WRITE_BUF_MEM		 0x7A //0x03

// Maks and some constants 
#define ADDR_MASK			      0x1F
#define BANK_MASK						0x60 // 0110 0000 // bank adresini registerdan ayiran özel bit
#define RXSTART_INIT	      0x0000  // Rx start
#define RXSTOP_INIT	        0x0BFF  // Rx stop
#define TXSTART_INIT	      0x0C00  // Tx start
#define TXSTOP_INIT	        0x11FF  // Tx stop
#define MAX_FRAMELEN	      1500
#define MISTAT_BUSY	        0x01

// Bank0 -control registers addresses      // her bankin control registerini ekledik:
#define ERDPT    0x00
#define EWRPT    0x02
#define ETXST    0x04
#define ETXND    0x06
...
#define EIE			    0x1B
#define EIR			    0x1C
#define ESTAT			  0x1D // syf : 66 estat reg..
#define ECON1			  0x1F
#define ECON2			  0x1E
...
uint8_t ENC28_readReg8(uint8_t addr);  // bu fonksiyonlar ile oper i bildirmeme gerek kalmaz
